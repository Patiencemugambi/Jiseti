...
const SignUp = () => {
  ...
  //   <div className="hidden lg:flex flex-col justify-center items-center w-1/2 bg-gradient-to-r from-red-500 to-[#3d0e15] text-white relative">
  ...
  //     <div className="w-full lg:w-1/2 p-8 flex justify-center items-center">
  //       <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-md">
  //         <h2 className="text-2xl font-semibold mb-4 text-center text-#595656">Sign Up</h2>
  //         <form onSubmit={handleSubmit}>
  //            {/* Username Input */}
  //           <div className="mb-4">
  //            <label className="block text-sm font-medium text-gray-600">Username:</label>
  ...
  //           </button>
  //         </form>
  //         {/* ... (existing success message and login link) */}
  //       </div>
  //     </div>
  //   </div>
  // );
